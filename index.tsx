import React, { useState, useMemo, FC, useRef, useCallback, useEffect } from 'https://esm.sh/react@18.3.1';
import { createRoot } from 'https://esm.sh/react-dom@18.3.1/client';
import type { GenerateContentResponse } from "https://esm.sh/@google/genai@0.12.0";
...
const BarChart: FC<BarChartProps> = ({ data, title, lang, noDataMessage }) => {
    // FIX: Explicitly cast the result of Object.entries to ensure correct typing for chart values, as some environments may infer it as `[string, unknown][]`.
    const chartEntries = Object.entries(data) as [string, { result: number; count: number }][];
...
const App: FC = () => {
  ...
  const aiInstanceRef = useRef<any>(null);
